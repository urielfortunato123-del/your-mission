    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <Tabs defaultValue="novidades" className="flex-1 overflow-hidden flex flex-col">
          ...
          {/* NOVIDADES */}
          <TabsContent value="novidades" className="mt-0 flex-1">
          ...
          {/* VISÃO GERAL */}
          <TabsContent value="visao-geral" className="mt-0 flex-1">
            <ScrollArea className="h-[60vh] pr-4">
              <div className="space-y-6">
                <section className="space-y-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2 text-primary">
          ...
          {/* ATIVIDADES */}
          <TabsContent value="atividades" className="mt-0 flex-1">
            <ScrollArea className="h-[60vh] pr-4">
              <div className="space-y-6">
                <section className="space-y-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2 text-primary">
          ...
          {/* MEDIÇÃO */}
          <TabsContent value="medicao" className="mt-0 flex-1">
            <ScrollArea className="h-[60vh] pr-4">
              <div className="space-y-6">
                <section className="space-y-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2 text-primary">
